<template>
  <div class="mx-10">
    ...
    <div class="app">
      <div class="bg-white h-[500px] w-1/3 p-4">
        <div class="text-[#2666de] text-xl font-medium">Các phiên đang chat</div>
        ...
        <div class="text-[#2666de] text-xl font-medium mt-10">Phiên chat thuộc {{ appName }}</div>
